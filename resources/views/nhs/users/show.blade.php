        ...
        <div class="card mb-3">
          <div class="card-header pt-1">
            <ul class="nav nav-tabs card-header-tabs" role="tablist">
              <li class="nav-item" role="presentation">
                <button type="button" class="nav-link active" data-bs-toggle="tab" role="tab" data-bs-target="#navs-tab-payments" aria-controls="navs-tab-payments" aria-selected="false" tabindex="-1">
                  Payments
                </button>
              </li>
            </ul>
          ...
          <div class="card-body pt-3">
            <div class="tab-content p-0">
              ...
              <div class="tab-pane active show" id="navs-tab-payments" role="tabpanel">
